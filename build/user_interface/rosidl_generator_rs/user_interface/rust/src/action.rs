...
impl rosidl_runtime_rs::Message for Fibonacci_Feedback {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Owned(msg.header)).into_owned(),
        temp_seq: msg.temp_seq.into(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        header: std_msgs::msg::Header::into_rmw_message(std::borrow::Cow::Borrowed(&msg.header)).into_owned(),
        temp_seq: msg.temp_seq.as_slice().into(),
      })
    }
  }
...
#[link(name = "user_interface__rosidl_typesupport_c")]
extern "C" {
    fn rosidl_typesupport_c__get_action_type_support_handle__user_interface__action__Fibonacci() -> *const std::ffi::c_void;
}

// Corresponds to user_interface__action__Fibonacci
#[allow(missing_docs, non_camel_case_types)]
...
impl rosidl_runtime_rs::Action for Fibonacci {
  ...
  fn get_type_support() -> *const std::ffi::c_void {
    // SAFETY: No preconditions for this function.
    unsafe { rosidl_typesupport_c__get_action_type_support_handle__user_interface__action__Fibonacci() }
  }
