...
{
public:
  explicit Init_Fibonacci_Feedback_temp_seq(::user_interface::action::Fibonacci_Feedback & msg)
  : msg_(msg)
  {}
...
class Init_Fibonacci_Feedback_header
{
public:
  Init_Fibonacci_Feedback_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Fibonacci_Feedback_temp_seq header(::user_interface::action::Fibonacci_Feedback::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_Fibonacci_Feedback_temp_seq(msg_);
  }
...
{
  return user_interface::action::builder::Init_Fibonacci_Feedback_header();
}
